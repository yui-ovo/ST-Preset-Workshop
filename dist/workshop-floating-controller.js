...
html body #${HANDLE_ID}.is-docked{width:max(28px,var(--pmm-floating-handle-width,28px))!important;height:max(28px,var(--pmm-floating-handle-width,28px))!important;border-radius:4px!important}
html body #${HANDLE_ID}.is-docked .pmm-ball-glyph{opacity:0}
html body #${HANDLE_ID}.is-docked .pmm-handle-glyph{opacity:1;transform:none!important;font-size:18px}
