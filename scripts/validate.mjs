...
if (!entry.includes('workshop-v3.02.js') || !entry.includes('preset-content-editor.js') || !entry.includes('worldbook-stitch-test3.js') || !entry.includes("const EXTENSION_VERSION = '2.97.23'")) {
