...
assert.ok(desktopStyle.includes('width:368px!important'), '展开框没有为收起按钮和快照入口新增的宽度留出空间');
...
console.log('test.45 回归通过：桌面浮动栏为快照入口扩宽并保留独立的 30px 收起热区，长预设名会优先收窄，手机端保持原尺寸。');
